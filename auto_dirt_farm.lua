...
-- OnValueFarm adalah global function, dipanggil dari OnValueConsole di gl_console.lua
-- OnDrawFarm pakai AddHookCallback agar tidak override OnDraw dari gl_console
AddHookCallback(function(d)
    if not _farmDrawDone then
        _farmDrawDone = true
        runCoroutine(function()
            sleep(5000)
            addCategory("Farming", "Grass")
